...
count_hour, task_count = 0, 0   # счетчик часов и количество задач равны 0
wife_status = False             # Жена пока не звонила
print('Начался 8-часовой рабочий день')
while count_hour < 8:
  count_hour += 1
  print(count_hour, 'час')
  task = int(input('Сколько задач решит Максим? '))
  task_count += task
  wife = int(input('Звонит жена. Взять трубку? (1-да, 0-нет): '))
  if wife == 1:
    wife_status = True
print('Рабочий день закончился. Максим решил', task_count, 'задач')
if wife_status == True:
